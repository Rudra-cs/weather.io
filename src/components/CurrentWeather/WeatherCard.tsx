...
const WeatherCard = (): JSX.Element => {
  ...
  return (
    <div className="flex flex-col border-solid border-[1px] border-slate-900 rounded-lg bg-gray-100 h-full py-8 px-6 ">
      <div className="">
        ...
        <p className="my-[14px] mx-[16px] font-medium text-4xl text-slate-900">
          {Math.floor(weatherdata?.main.temp)}°C
        </p>
        <p className="tracking-wide my-[14px] mx-[16px] capitalize  text-base text-slate-900">
          {weatherdata?.weather[0].main}
        </p>
        <hr className=" my-[25px] mx-[16px] border-solid border-t-1 border-slate-900 max-w-[75%]" />
        <div className="flex flex-row my-[14px] mx-[16px]">
          <svg
            className="mr-5"
            width="24"
          ...
          <p className=" text-slate-900 capitalize text-base tracking-wide">
        ...
        <div className="flex flex-row mx-[16px]">
          ...
          <p className=" tracking-wide capitalize text-base text-slate-900">
            {time}
          </p>
        </div>
      </div>
